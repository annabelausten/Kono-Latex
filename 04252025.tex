...
Jai-\textsc{3SG.PST} Saa\textipa{obj} asked (\textsc{foc}) yesterday.\\
``Jai asked Saa yesterday.''
...
\exg. \textipa{w\'o} \textipa{\'an\`a} \textipa{k\'aNg\'an-\`a} \textipa{t\'{\~o}} \textipa{k\`un\`u}.\\
...
\exg. \textipa{\'a-m} \textipa{f-\'an\`a} \textipa{k\'aNg\'an-\`a} \textipa{t\'{\~o}} \textipa{k\`un\`u}.\\
