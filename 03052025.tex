...
1SG.PST Bondu 3SG.ɔSer ask whether PST meat eat ? yesterday \\
...
1SG-PST.OBJ ask whether Bondu PST meat eat ? yesterday \\
    `I asked him/her whether Bondu ate meat yesterday'
    \jf{(the "a" in "na" (1SG.Ser2) seems to be elided and replaced by "ɔ" 3SG.ɔSer)}\\

\exg. na jɔ tisa ne bondu a swee dao faŋ kunu\\
1SG.PST 2SG-OBJ ask whether Bondu PST meat eat ? yesterday \\
...
Kai 3SG ?-say Bondu PST meat eat yesterday\\
...
1SG-PST.OBJ ask Bondu PST what eat yesterday\\
...
1SG.PST ask-v who-PST meat eat yesterday\\
    `I asked who (pl.) ate meat yesterday'
    \jf{(Like, if some people meat and others vegetables)} 

\exg. n-ɔ tisa ɲon-á swee dao kunu\\
1SG-PST.OBJ ask who-PST meet eat yesterday\\
    `I asked who (pl.) ate meat yesterday'
    \jf{(Like, if some people meat and others vegetables)}
...
who-PST s\textipa{E}\textipa{E} buy \\
`Who bought the see?'
...
`What\mss{k} did Kai say [that Bondu bought \trace{k}]? '
\chs{may be an indirect question}

\exg. K\`{a}\`{i} \'{\textipa{O}} t\'{e} ɲ\'{o}n-\`{a} s\`{\textipa{E}}\'{\textipa{E}} sã̀? \\ 
Kai 3SG say who-PST s\textipa{E}\textipa{E} buy \\
...
who-PST s\textipa{E}\textipa{E} 3SG break \\
